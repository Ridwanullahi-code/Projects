...
- The 4 sections you need to build for this project are:
    ...
    - the headline section (right after the header)
		- the reason to choose us section (right after the headline)
    - The footer section (right after the `how we work section`)
...
- Your website should **look exactly like the design** (e.g. _font_, _colors_, _images_, _text_, _margins_) using ![the design](./design/desktop-design.jpg).
